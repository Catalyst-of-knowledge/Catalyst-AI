...
以下の資料全体を一つの研究論文として捉え、【IMRAD形式】で専門家レベルの構造化要約を作成してください。
